...
fn tr_3() {
    ...
    let genesis_hash =
        H256::from_str("6408de7737c59c238890533af25896a2c20608d8b380bb01029acb392781063e").unwrap();
    let block_hash =
        H256::from_str("0615071566c93df347d71e05b75ed360c8d99ef8a28334ebd50d6d2f337ff87c").unwrap();
    ...
    let params = BaseExtrinsicParams::<PolkadotConfig, PlainTip>::new(
        ...
        genesis_hash,
        BaseExtrinsicParamsBuilder::new()
            .tip(PlainTip::new(1000000000))
            .era(Era::Mortal(0, 8215485), block_hash),
    );
...
fn tr_5() {
    ...
    let dest = AccountId32::from_str(
        "25rZGFcFEWz1d81xB98PJN8LQu5cCwjyazAerGkng5NDuk9C"
    )
        .unwrap()
        .into();
